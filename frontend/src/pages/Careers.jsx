  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={<>Build Your Career <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">With Us.</span></>}
        description="Join Task19 Technologies and build your career in e-commerce, web development, mobile apps, AI, and digital transformation."
