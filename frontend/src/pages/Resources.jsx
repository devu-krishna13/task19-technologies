...
export default function Resources() {
  return (
    <div className="bg-[#FFFFFF] min-h-screen">
      <Helmet>
        <title>Resource Augmentation — Task19 Technologies</title>
      </Helmet>
      ...
      <section className="relative overflow-hidden bg-primary hero-section-wrapper min-h-[500px] h-[70svh] md:h-[80vh] flex items-center">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?auto=format&fit=crop&crop=center&w=1920&h=1080&q=90"
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-center pt-20 md:pt-0">
          <div className="container relative flex flex-col items-center text-center px-4 sm:px-6 mx-auto">
            ...
            >
              <span className="text-white/90 text-[12px] md:text-sm font-medium">Expert Talent</span>
            </motion.div>
            ...
            >
              <h1 className="font-display font-bold text-white leading-[1.15] md:leading-[1.1] tracking-tight mb-6 md:mb-8" style={{ fontSize: 'clamp(2.25rem, 8vw, 4.5rem)' }}>
                Resource <em className="font-serif-italic not-italic text-white/40">Augmentation.</em>
              </h1>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 container">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-6 text-gray-900">Scale Your Engineering Team</h2>
          <p className="text-lg text-gray-600 mb-10 leading-relaxed">
            Need to scale your development capacity quickly? Our resource augmentation services provide you with pre-vetted, highly skilled engineers, designers, and project managers who seamlessly integrate into your existing workflows and company culture.
          </p>
          <Link to="/contact" className="inline-flex items-center gap-2 bg-[#013Ad6] text-white px-8 py-3 rounded-full font-bold uppercase tracking-wide hover:bg-blue-800 transition-colors">
            Hire Top Talent <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
    </div>
