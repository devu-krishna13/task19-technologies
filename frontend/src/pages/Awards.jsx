  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen">
      ...
      <PageHero
        ...
        title={<>Awards & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Recognitions.</span></>}
        description="Celebrating excellence and our commitment to delivering world-class digital solutions."
