...
import { ArrowRight, Play, LayoutDashboard, Clock, Zap, Box, Tag, Settings } from 'lucide-react'
  ...
  return (
    <>
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <picture>
            ...
            <img
              ...
              alt="Page Booster Hero Background"
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-center pt-8 md:pt-0">
          <div className="container relative flex flex-col items-center text-center px-4 sm:px-6 mx-auto">
            ...
            >
              ...
              <span className="text-white/90 text-[12px] md:text-sm font-medium">Shopify Sales App</span>
            </motion.div>
            ...
            >
              <h1 className="font-display font-bold text-white leading-[1.15] md:leading-[1.1] tracking-tight mb-3 md:mb-6" style={{ fontSize: 'clamp(2.25rem, 8vw, 5rem)' }}>
                Turn Browsers Into <br /><em className="font-serif-italic not-italic text-white/40">Buyers.</em>
              </h1>
            ...
            >
              <a 
                href="https://productdiscount.task19.com/home" 
                target="_blank"
              ...
              <a 
                href="https://youtu.be/fjfwCB6EA9w?si=sNY2txIamNsRngZc" 
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              { value: '1M+', label: 'Coupons Created' },
            ...
            {[
              {
                ...
                desc: 'Install Page Booster - Product Blocks from the Shopify App Store. We\'ll automatically sync your products and theme settings in seconds.'
              },
              {
                step: '02',
              ...
              },
              {
                step: '03',
                title: 'Go Live',
                desc: 'Enable the widgets with one click. They\'ll start appearing on your product and cart pages immediately, blending perfectly with your theme.'
              }
            ].map((item, i) => (
              <motion.div 
                key={i}
      ...
      <section className="py-10 md:py-12 bg-white">
        <div className="container px-4 mx-auto max-w-4xl text-center">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Boost Sales with Smart Delivery, Coupons & AI Features
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed font-light">
            Page Booster is a powerful Shopify app that helps you increase sales by showing estimated delivery dates, product-specific coupon codes, AI-generated product features, and bundle offers directly on your product pages. It automatically syncs discounts with your Shopify store and works smoothly within your theme. From highlighting key product benefits to displaying special offers at the right moment, this app helps build customer trust, improve conversions, and turn visitors into buyers.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 md:py-12 bg-gray-50 border-t border-gray-100">
        <div className="container px-4 mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h4 className="text-blue-600 font-bold tracking-widest uppercase text-sm mb-3">Everything You Need to Boost Sales</h4>
            <h2 className="font-display text-4xl font-bold text-gray-900 mb-4">
              Powerful features designed to solve merchant pain points.
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'Control everything from one simple dashboard.'
              },
              {
                icon: Clock,
                title: 'Delivery Dates',
                desc: 'Show estimated delivery dates to reduce cart abandonment'
              },
              {
                icon: Zap,
                title: 'AI Features',
                desc: 'Generate compelling product features automatically using AI'
              },
              {
                icon: Box,
                title: 'Product Bundles',
                desc: 'Create combo deals and bundles with custom pricing to bump average order value'
              },
              {
                icon: Settings,
                title: 'Instant Setup',
                desc: 'No coding required – widgets install automatically and blend perfectly'
              },
              {
                icon: Tag,
                title: 'Smart Coupons',
                desc: 'Product-specific discount codes appear automatically on cart pages'
              }
            ].map((feature, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-10 md:py-12 bg-white border-t border-gray-100 relative overflow-hidden">
        ...
        <div className="container relative z-10 px-4 mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-gray-500 font-light mb-4 md:mb-10">
            Join thousands of Shopify merchants using Page Booster – Product Blocks to build trust and drive more conversions.
          </p>
          <a 
            href="https://apps.shopify.com/product-discount-3?st_source=autocomplete&surface_detail=autocomplete_apps" 
            target="_blank"
            rel="noopener noreferrer"
