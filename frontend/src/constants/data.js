export const portfolioItems = [
  ...
  },
  {
    ...
    metric: '35%',
    metricLabel: 'Quiz-to-Purchase Rate',
  ...
  },
  {
    ...
    metric: '$120K',
    metricLabel: 'International Sales Year 1',
...
export const testimonials = [
  {
    ...
    role: 'CEO',
    industry: 'Art & Craft',
    avatar: 'https://ui-avatars.com/api/?name=Arjun+Mehta&background=013ad6&color=fff&size=120&bold=true',
  ...
  },
  {
    ...
    industry: 'Luxury Accessories',
    avatar: 'https://ui-avatars.com/api/?name=Sarah+Al-Rashidi&background=7c3aed&color=fff&size=120&bold=true',
  ...
  },
  {
    ...
    industry: 'Beauty & Wellness',
    avatar: 'https://ui-avatars.com/api/?name=Priya+Nair&background=06b6d4&color=fff&size=120&bold=true',
    content: 'The skin quiz they developed for us is now our most powerful sales tool. 35% of quiz completions result in a purchase — far above industry average. The team\'s understanding of consumer psychology is remarkable.',
    rating: 5,
  },
  {
    name: 'Daniel Chen',
    ...
    role: 'Co-Founder',
    industry: 'Food & Beverage',
    avatar: 'https://ui-avatars.com/api/?name=Daniel+Chen&background=10b981&color=fff&size=120&bold=true',
  ...
  },
  {
    ...
    industry: 'Handcraft & Artisan',
    avatar: 'https://ui-avatars.com/api/?name=Fatima+Hussain&background=f59e0b&color=fff&size=120&bold=true',
    content: 'We had a vision to connect Indian artisans with the world. Task19 brought that vision to life with a platform that even artisans with no tech experience can manage confidently. Truly remarkable work.',
    rating: 5,
  },
]
...
export const teamMembers = [
  {
    name: 'Rajesh Kumar',
    role: 'Founder & CEO',
    bio: 'A visionary entrepreneur with 12+ years in e-commerce technology, Rajesh founded Task19 with a clear mission: to give ambitious brands the technical horsepower they need.',
    social: { linkedin: '#', twitter: '#' },
  },
  {
    name: 'Ananya Krishnan',
    role: 'Head of Technology',
    bio: 'With a background in distributed systems and e-commerce architecture, Ananya leads our engineering team in building scalable, performant solutions.',
    social: { linkedin: '#' },
  },
  {
  ...
  },
  {
    ...
    bio: 'Divya ensures every client project delivers measurable ROI. Her consultative approach transforms client relationships into strategic partnerships.',
    social: { linkedin: '#' },
  },
]
...
export const clientBrands = [
  { name: 'Paintemic', logo: null },
  { name: 'DSNY Online', logo: null },
  { name: 'RIZA UAE', logo: null },
  { name: 'Mazara', logo: null },
  { name: 'Pisang', logo: null },
  { name: 'Folk & Fab', logo: null },
  { name: 'Goodwill', logo: null },
  { name: 'Habibi Shopping', logo: null },
  { name: 'Karenzi', logo: null },
  { name: 'Cadfour', logo: null },
  { name: 'Usedifi', logo: null },
  { name: 'Al Ershad', logo: null },
  { name: 'Ebarza', logo: null },
  { name: 'StyleMix', logo: null },
]
