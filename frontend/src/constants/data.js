export const portfolioItems = [
  {
    id: 1, slug: 'caribou-coffee',
    title: 'Caribou Coffee',
    category: 'Food',
    client: 'Caribou Coffee',
    industry: 'Food',
    shortDesc: 'Helping a reputed coffee chain go digital with a powerful app in their Kuwait chapter.',
    image: 'https://admin.wac.co/uploads/careebu_coffee_19e3d1a32c.png',
  ...
  {
    id: 2, slug: 'lulu-hypermarket',
    title: 'LuLu Hypermarket',
    category: 'Retail',
    client: 'LuLu',
    industry: 'Retail',
    shortDesc: 'Building a one-click path for a search-intensive, high volume big brand store.',
    image: 'https://admin.wac.co/uploads/LULU_Thumb_2_c17c456ffc.jpg',
    technologies: ['React', 'Node.js'],
    results: [],
    metric: '',
    metricLabel: '',
  ...
  {
    id: 3, slug: 'middlesex-university',
    title: 'Middlesex University',
    category: 'Education',
    client: 'Middlesex University',
    industry: 'Education',
    shortDesc: 'Revamping the digital face of a world-class university for better visual impact.',
    image: 'https://admin.wac.co/uploads/middlesex_fb62084b71.png',
    technologies: ['React', 'Node.js'],
    results: [],
    metric: '',
    metricLabel: '',
  ...
  },
  {
    ...
    client: 'Yallatoys',
    industry: 'Retail',
    shortDesc: 'Elevating Qatar\'s No.1 toy brand with our digital prowess in web, app, and digital marketing.',
    image: 'https://admin.wac.co/uploads/yallatoys_0ca8d87e79.png',
    technologies: ['React', 'Node.js'],
    results: [],
    metric: '',
    metricLabel: '',
  ...
  },
  {
    ...
    shortDesc: 'Reshaping the entire digital landscape for India\'s foremost design-led, interior fit-out brand.',
    image: 'https://admin.wac.co/uploads/dtale_banner_213f5b1981.png',
    technologies: ['React', 'Node.js'],
    results: [],
    metric: '',
    metricLabel: '',
  ...
  },
  {
    ...
    client: 'IKEA',
    industry: 'Retail',
    shortDesc: 'Delectably designed branded E-commerce store to launch a new sales channel.',
    image: 'https://admin.wac.co/uploads/ikea_54473e2d09.png',
    technologies: ['React', 'Node.js'],
    results: [],
    metric: '',
    metricLabel: '',
